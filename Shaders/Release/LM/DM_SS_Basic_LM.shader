...
/*SF_DATA;ver:1.02;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:True,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:3865,x:33228,y:32878,varname:node_3865,prsc:2|diff-8576-RGB,spec-5751-RGB,gloss-5751-A,normal-2290-RGB,amspl-5481-RGB;n:type:ShaderForge.SFN_Tex2d,id:2290,x:32590,y:33124,ptovrint:False,ptlb:BumpMap,ptin:_BumpMap,varname:node_2290,prsc:2,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Color,id:8576,x:32590,y:32463,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_8576,prsc:2,glob:False,c1:0.6,c2:0.6,c3:0.6,c4:1;n:type:ShaderForge.SFN_SkyshopSpec,id:5481,x:32590,y:32890,varname:node_5481,prsc:2,sprot:True,spblend:True,splmocc:True|GLOSS-5751-A;n:type:ShaderForge.SFN_Color,id:5751,x:32590,y:32661,ptovrint:False,ptlb:SpecColor,ptin:_SpecColor,varname:node_5751,prsc:2,glob:False,c1:0.6,c2:0.6,c3:0.6,c4:0.8;proporder:8576-5751-2290;pass:END;sub:END;*/

Shader "DM2/DM_SS_Basic_LM" {
    Properties {
        _Color ("Color", Color) = (0.6,0.6,0.6,1)
        _SpecColor ("SpecColor", Color) = (0.6,0.6,0.6,0.8)
...
/////// Vectors:
                ...
                return fixed4( normalDirection * 0.5 + 0.5, max(_SpecColor.a,0.0078125) );
            }
            ENDCG
        }
        Pass {
...
////// Lighting:
                half4 lightAccumulation = tex2Dproj(_LightBuffer, UNITY_PROJ_COORD(i.projPos));
                    ...
                    half3 lightmapAccumulation = half3(0,0,0);
                        ...
                        float lmspec = pow (nh, _SpecColor.a * 128.0);
...
////// Specular:
                ...
                float specPow = max( 2, _SpecColor.a * 128 );
                float normTerm = (specPow + 8.0 ) / (8.0 * Pi);
                float3 directSpecular = (lightAccumulation.rgb * 2)*lightAccumulation.a*normTerm;
                float3 indirectSpecular = (0 + (lightmap*marmoMipSpecular(viewReflectDirection, i.posWorld.rgb, _SpecColor.a)).rgb);
