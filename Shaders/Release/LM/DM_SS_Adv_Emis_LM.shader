...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:True,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:2,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:3865,x:34003,y:32846,varname:node_3865,prsc:2|diff-9902-OUT,spec-4301-OUT,gloss-9795-A,normal-2290-RGB,emission-2733-OUT,amspl-5481-RGB,difocc-8989-OUT,spcocc-8989-OUT;n:type:ShaderForge.SFN_Tex2d,id:2290,x:32616,y:33595,ptovrint:False,ptlb:BumpMap,ptin:_BumpMap,varname:node_2290,prsc:2,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Color,id:8576,x:32600,y:32059,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_8576,prsc:2,glob:False,c1:0.6,c2:0.6,c3:0.6,c4:1;n:type:ShaderForge.SFN_SkyshopSpec,id:5481,x:32616,y:33365,varname:node_5481,prsc:2,sprot:True,spblend:True,splmocc:False|GLOSS-9795-A;n:type:ShaderForge.SFN_Tex2d,id:7884,x:32600,y:31860,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:node_7884,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:8110,x:32951,y:32033,varname:node_8110,prsc:2|A-7884-RGB,B-8576-RGB,T-7323-OUT;n:type:ShaderForge.SFN_Vector1,id:7323,x:32784,y:32141,varname:node_7323,prsc:2,v1:0;n:type:ShaderForge.SFN_Tex2d,id:5602,x:32616,y:33835,ptovrint:False,ptlb:AOMap,ptin:_AOMap,varname:node_5602,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:9902,x:33199,y:32212,varname:node_9902,prsc:2|A-8110-OUT,B-8989-OUT;n:type:ShaderForge.SFN_Slider,id:5924,x:32461,y:34134,ptovrint:False,ptlb:AOAmt,ptin:_AOAmt,varname:node_5924,prsc:2,min:1,cur:1,max:0;n:type:ShaderForge.SFN_Lerp,id:8989,x:32978,y:33818,varname:node_8989,prsc:2|A-5602-RGB,B-6365-OUT,T-5924-OUT;n:type:ShaderForge.SFN_Vector4,id:6365,x:32618,y:34007,varname:node_6365,prsc:2,v1:1,v2:1,v3:1,v4:1;n:type:ShaderForge.SFN_Fresnel,id:2744,x:32500,y:32620,varname:node_2744,prsc:2|EXP-7237-OUT;n:type:ShaderForge.SFN_Add,id:4301,x:32959,y:32603,varname:node_4301,prsc:2|A-9795-RGB,B-1132-OUT;n:type:ShaderForge.SFN_Slider,id:7237,x:32125,y:32707,ptovrint:False,ptlb:IOR,ptin:_IOR,varname:node_7237,prsc:2,min:1,cur:1,max:0.1;n:type:ShaderForge.SFN_Slider,id:1386,x:32125,y:32816,ptovrint:False,ptlb:IORAmt,ptin:_IORAmt,varname:node_1386,prsc:2,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Multiply,id:1132,x:32710,y:32620,varname:node_1132,prsc:2|A-2744-OUT,B-1386-OUT;n:type:ShaderForge.SFN_Tex2d,id:9795,x:32600,y:32247,ptovrint:False,ptlb:SpecMap,ptin:_SpecMap,varname:node_9795,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:2331,x:33460,y:32907,varname:node_2331,prsc:2|A-3376-OUT,B-2424-OUT,C-6943-OUT,D-5602-RGB;n:type:ShaderForge.SFN_Color,id:9210,x:32959,y:32770,ptovrint:False,ptlb:LightColor,ptin:_LightColor,varname:node_9210,prsc:2,glob:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:3376,x:33284,y:32677,varname:node_3376,prsc:2|A-7884-RGB,B-9210-RGB;n:type:ShaderForge.SFN_ValueProperty,id:2424,x:32959,y:32959,ptovrint:False,ptlb:LightIntensity,ptin:_LightIntensity,varname:node_2424,prsc:2,glob:False,v1:1;n:type:ShaderForge.SFN_ValueProperty,id:2923,x:32521,y:33029,ptovrint:False,ptlb:LightDistance,ptin:_LightDistance,varname:node_2923,prsc:2,glob:False,v1:20;n:type:ShaderForge.SFN_Vector4Property,id:1128,x:32378,y:33098,ptovrint:False,ptlb:LightPos,ptin:_LightPos,varname:node_1128,prsc:2,glob:False,v1:0,v2:0,v3:0,v4:0;n:type:ShaderForge.SFN_Distance,id:8890,x:32630,y:33118,varname:node_8890,prsc:2|A-1128-XYZ,B-2018-XYZ;n:type:ShaderForge.SFN_FragmentPosition,id:2018,x:32435,y:33252,varname:node_2018,prsc:2;n:type:ShaderForge.SFN_Subtract,id:4673,x:32822,y:33068,varname:node_4673,prsc:2|A-2923-OUT,B-8890-OUT;n:type:ShaderForge.SFN_Divide,id:6209,x:33004,y:33019,varname:node_6209,prsc:2|A-4673-OUT,B-2923-OUT;n:type:ShaderForge.SFN_Max,id:6943,x:33277,y:33023,varname:node_6943,prsc:2|A-6209-OUT,B-1952-OUT;n:type:ShaderForge.SFN_Vector1,id:1952,x:33075,y:33162,varname:node_1952,prsc:2,v1:0;n:type:ShaderForge.SFN_Multiply,id:2733,x:33677,y:32998,varname:node_2733,prsc:2|A-2331-OUT,B-4481-OUT;n:type:ShaderForge.SFN_Lerp,id:4481,x:33594,y:33179,varname:node_4481,prsc:2|A-354-OUT,B-6365-OUT,T-7503-OUT;n:type:ShaderForge.SFN_Fresnel,id:8709,x:33215,y:33206,varname:node_8709,prsc:2;n:type:ShaderForge.SFN_RemapRange,id:354,x:33355,y:33103,varname:node_354,prsc:2,frmn:0,frmx:1,tomn:1,tomx:0|IN-8709-OUT;n:type:ShaderForge.SFN_Slider,id:7503,x:33198,y:33385,ptovrint:False,ptlb:IllumIOR,ptin:_IllumIOR,varname:node_7503,prsc:2,min:1,cur:1,max:0;proporder:7884-8576-9795-7237-1386-7503-2290-5602-5924-9210-2424-2923-1128;pass:END;sub:END;*/

Shader "DM2/DM_SS_Adv_Emis_LM" {
    Properties {
        _MainTex ("MainTex", 2D) = "white" {}
        _Color ("Color", Color) = (0.6,0.6,0.6,1)
        _SpecMap ("SpecMap", 2D) = "white" {}
        _IOR ("IOR", Range(1, 0.1)) = 1
        _IORAmt ("IORAmt", Range(0, 1)) = 0
        _IllumIOR ("IllumIOR", Range(1, 0)) = 1
        _BumpMap ("BumpMap", 2D) = "bump" {}
        _AOMap ("AOMap", 2D) = "white" {}
        _AOAmt ("AOAmt", Range(1, 0)) = 1
        _LightColor ("LightColor", Color) = (1,1,1,1)
        _LightIntensity ("LightIntensity", Float ) = 1
        _LightDistance ("LightDistance", Float ) = 20
...
////// Lighting:
				...
				float4 _SpecMap_var = tex2D(_SpecMap,TRANSFORM_TEX(i.uv0, _SpecMap));
                    ...
                    half3 lightmapAccumulation = half3(0,0,0);
                        ...
                        _SpecMap_var = tex2D(_SpecMap,TRANSFORM_TEX(i.uv0, _SpecMap));
                        float lmspec = pow (nh, _SpecMap_var.a * 128.0);
                        half3 specColor = lm * (_SpecMap_var.rgb+(pow(1.0-max(0,dot(normalDirection, viewDirection)),_IOR)*_IORAmt)) * lmspec;
...
////// Specular:
                ...
                float4 node_6365 = float4(1,1,1,1);
                float4 node_8989 = lerp(float4(_AOMap_var.rgb,0.0),node_6365,_AOAmt);
                float3 specularAO = node_8989.rgb;
                float3 specularColor = (_SpecMap_var.rgb+(pow(1.0-max(0,dot(normalDirection, viewDirection)),_IOR)*_IORAmt));
...
////// Emissive:
                float node_354 = ((1.0-max(0,dot(normalDirection, viewDirection)))*-1.0+1.0);
                float3 emissive = (((_MainTex_var.rgb*_LightColor.rgb)*_LightIntensity*max(((_LightDistance-distance(_LightPos.rgb,i.posWorld.rgb))/_LightDistance),0.0)*_AOMap_var.rgb)*lerp(float4(node_354,node_354,node_354,node_354),node_6365,_IllumIOR)).rgb;
/// Final Color:
