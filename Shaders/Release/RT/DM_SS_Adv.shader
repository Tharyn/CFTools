...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:3865,x:33721,y:32835,varname:node_3865,prsc:2|diff-9902-OUT,spec-4301-OUT,gloss-9795-A,normal-2290-RGB,amdfl-8714-OUT,amspl-3238-OUT,difocc-8989-OUT,spcocc-8989-OUT;n:type:ShaderForge.SFN_Tex2d,id:2290,x:32604,y:33305,ptovrint:False,ptlb:BumpMap,ptin:_BumpMap,varname:node_2290,prsc:2,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Color,id:8576,x:32600,y:32059,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_8576,prsc:2,glob:False,c1:0.6,c2:0.6,c3:0.6,c4:1;n:type:ShaderForge.SFN_SkyshopSpec,id:5481,x:32604,y:33075,varname:node_5481,prsc:2,sprot:True,spblend:True,splmocc:False|GLOSS-9795-A;n:type:ShaderForge.SFN_Tex2d,id:7884,x:32600,y:31860,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:node_7884,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:8110,x:32951,y:32033,varname:node_8110,prsc:2|A-7884-RGB,B-8576-RGB,T-7323-OUT;n:type:ShaderForge.SFN_Vector1,id:7323,x:32784,y:32141,varname:node_7323,prsc:2,v1:0;n:type:ShaderForge.SFN_Tex2d,id:5602,x:32604,y:33545,ptovrint:False,ptlb:AOMap,ptin:_AOMap,varname:node_5602,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:9902,x:33199,y:32212,varname:node_9902,prsc:2|A-8110-OUT,B-8989-OUT;n:type:ShaderForge.SFN_Slider,id:5924,x:32449,y:33844,ptovrint:False,ptlb:AOAmt,ptin:_AOAmt,varname:node_5924,prsc:2,min:1,cur:0.5,max:0;n:type:ShaderForge.SFN_SkyshopDiff,id:6106,x:32604,y:32858,varname:node_6106,prsc:2,dfrot:True,dfblend:True,dflmocc:False;n:type:ShaderForge.SFN_Lerp,id:8989,x:32966,y:33528,varname:node_8989,prsc:2|A-5602-RGB,B-6365-OUT,T-5924-OUT;n:type:ShaderForge.SFN_Vector4,id:6365,x:32606,y:33717,varname:node_6365,prsc:2,v1:1,v2:1,v3:1,v4:1;n:type:ShaderForge.SFN_Slider,id:6201,x:32763,y:32997,ptovrint:False,ptlb:IBLAmt,ptin:_IBLAmt,varname:node_6201,prsc:2,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Multiply,id:8714,x:33004,y:32827,varname:node_8714,prsc:2|A-6106-RGB,B-6201-OUT;n:type:ShaderForge.SFN_Fresnel,id:2744,x:32488,y:32523,varname:node_2744,prsc:2|EXP-7237-OUT;n:type:ShaderForge.SFN_Add,id:4301,x:32953,y:32504,varname:node_4301,prsc:2|A-9795-RGB,B-1132-OUT;n:type:ShaderForge.SFN_Slider,id:7237,x:32102,y:32541,ptovrint:False,ptlb:IOR,ptin:_IOR,varname:node_7237,prsc:2,min:8,cur:8,max:0.1;n:type:ShaderForge.SFN_Slider,id:1386,x:32102,y:32684,ptovrint:False,ptlb:IORAmt,ptin:_IORAmt,varname:node_1386,prsc:2,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Multiply,id:1132,x:32715,y:32523,varname:node_1132,prsc:2|A-2744-OUT,B-1386-OUT;n:type:ShaderForge.SFN_Tex2d,id:9795,x:32600,y:32247,ptovrint:False,ptlb:SpecMap,ptin:_SpecMap,varname:node_9795,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:4833,x:32763,y:33188,ptovrint:False,ptlb:ReflectAmt,ptin:_ReflectAmt,varname:node_4833,prsc:2,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Multiply,id:3238,x:33106,y:33056,varname:node_3238,prsc:2|A-5481-RGB,B-4833-OUT;proporder:7884-8576-9795-7237-1386-4833-2290-6201-5602-5924;pass:END;sub:END;*/

Shader "DM2/DM_Adv_SS" {
    Properties {
        _MainTex ("MainTex", 2D) = "white" {}
        _Color ("Color", Color) = (0.6,0.6,0.6,1)
        _SpecMap ("SpecMap", 2D) = "white" {}
        _IOR ("IOR", Range(8, 0.1)) = 8
        _IORAmt ("IORAmt", Range(0, 1)) = 0.5
        _ReflectAmt ("ReflectAmt", Range(0, 1)) = 0.5
        _BumpMap ("BumpMap", 2D) = "bump" {}
        _IBLAmt ("IBLAmt", Range(0, 1)) = 0.5
        _AOMap ("AOMap", 2D) = "white" {}
        _AOAmt ("AOAmt", Range(1, 0)) = 0.5
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Specular:
                ...
                float3 indirectSpecular = (0 + (marmoMipSpecular(viewReflectDirection, i.posWorld.rgb, _SpecMap_var.a).rgb*_ReflectAmt)) * specularAO;
