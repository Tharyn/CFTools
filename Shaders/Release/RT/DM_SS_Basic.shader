...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:3865,x:33228,y:32878,varname:node_3865,prsc:2|diff-8576-RGB,spec-5751-RGB,gloss-5751-A,normal-2290-RGB,amdfl-9235-OUT,amspl-5481-RGB;n:type:ShaderForge.SFN_Tex2d,id:2290,x:32569,y:33566,ptovrint:False,ptlb:BumpMap,ptin:_BumpMap,varname:node_2290,prsc:2,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Color,id:8576,x:32590,y:32463,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_8576,prsc:2,glob:False,c1:0.6,c2:0.6,c3:0.6,c4:1;n:type:ShaderForge.SFN_SkyshopSpec,id:5481,x:32590,y:32890,varname:node_5481,prsc:2,sprot:True,spblend:True,splmocc:False|GLOSS-5751-A;n:type:ShaderForge.SFN_Color,id:5751,x:32590,y:32661,ptovrint:False,ptlb:SpecColor,ptin:_SpecColor,varname:node_5751,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:0.8;n:type:ShaderForge.SFN_SkyshopDiff,id:6340,x:32451,y:33102,varname:node_6340,prsc:2,dfrot:True,dfblend:True,dflmocc:False;n:type:ShaderForge.SFN_Multiply,id:9235,x:32763,y:33106,varname:node_9235,prsc:2|A-6340-RGB,B-5622-OUT;n:type:ShaderForge.SFN_Slider,id:5622,x:32388,y:33351,ptovrint:False,ptlb:IBLAmt,ptin:_IBLAmt,varname:node_5622,prsc:2,min:0,cur:0.5,max:1;proporder:8576-5751-2290-5622;pass:END;sub:END;*/

Shader "DM2/DM_SS_Basic" {
    Properties {
        _Color ("Color", Color) = (0.6,0.6,0.6,1)
        _SpecColor ("SpecColor", Color) = (0.5,0.5,0.5,0.8)
