...
/*SF_DATA;ver:1.06;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:4580,x:33663,y:32735,varname:node_4580,prsc:2|diff-5270-RGB,spec-6519-RGB,gloss-6519-A;n:type:ShaderForge.SFN_Color,id:5270,x:32949,y:32645,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_5270,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Color,id:6519,x:32949,y:32862,ptovrint:False,ptlb:Spec,ptin:_Spec,varname:node_6519,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;proporder:5270-6519;pass:END;sub:END;*/
...
/////// Vectors:
                ...
                return fixed4( normalDirection * 0.5 + 0.5, max(_Spec.a,0.0078125) );
            }
            ENDCG
        }
        Pass {
...
////// Specular:
                ...
                float specPow = max( 2, _Spec.a * 128 );
