...
/*SF_DATA;ver:1.02;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:29,x:33110,y:32590,varname:node_29,prsc:2|diff-7239-RGB,emission-8814-OUT;n:type:ShaderForge.SFN_Color,id:7239,x:32464,y:32593,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_7239,prsc:2,glob:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Fresnel,id:8574,x:32553,y:32978,varname:node_8574,prsc:2|EXP-1258-OUT;n:type:ShaderForge.SFN_Slider,id:1258,x:32167,y:33089,ptovrint:False,ptlb:RimIOR,ptin:_RimIOR,varname:node_1258,prsc:2,min:4,cur:2.402287,max:0;n:type:ShaderForge.SFN_Multiply,id:5162,x:32741,y:32978,varname:node_5162,prsc:2|A-8574-OUT,B-5307-OUT;n:type:ShaderForge.SFN_Slider,id:5307,x:32258,y:33205,ptovrint:False,ptlb:RimAmt,ptin:_RimAmt,varname:node_5307,prsc:2,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Multiply,id:8814,x:32823,y:32728,varname:node_8814,prsc:2|A-7239-RGB,B-5162-OUT;proporder:7239-1258-5307;pass:END;sub:END;*/
...
////// Emissive:
                float3 emissive = (_Color.rgb*(pow(1.0-max(0,dot(normalDirection, viewDirection)),_RimIOR)*_RimAmt));
/// Final Color:
