...
Shader "DM2/DM_SS_Adv_LM_Retired" {
    Properties {
...
float3 indirectSpecular = (0 + (marmoMipSpecular(viewReflectDirection, i.posWorld.rgb, _SpecMap_var.a).rgb) * specularAO * lightAccumulation.rgb );
