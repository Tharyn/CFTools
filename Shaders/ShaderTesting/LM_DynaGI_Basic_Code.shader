...
/////// Diffuse:
                ...
                #ifndef LIGHTMAP_OFF
					/* Emissive:
					float GIStr = (1.0 - (distance(_L1Pos.rgb,i.posWorld.rgb)/_L1Falloff));
					float GIClamp = clamp(node_5716,0,1);
					float3 emissive = float3(GIClamp, GIClamp, GIClamp);
					*/
...
/////// Diffuse:
                ...
                diffuse *= 1-specularMonochrome;
////// Emissive:
                float node_5716 = (1.0 - (distance(_L1Pos.rgb,i.posWorld.rgb)/_L1Falloff));
                float node_6549 = clamp(node_5716,0,1);
                float3 emissive = float3(node_6549,node_6549,node_6549);
/// Final Color:
