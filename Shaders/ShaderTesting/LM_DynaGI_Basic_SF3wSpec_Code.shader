...
/*SF_DATA;ver:1.02;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:False,mssp:True,lmpd:True,lprd:False,rprd:False,enco:True,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:1,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:9289,x:33841,y:32653,varname:node_9289,prsc:2|diff-8161-RGB,spec-861-RGB,gloss-861-A,amspl-4121-RGB;n:type:ShaderForge.SFN_Color,id:8122,x:32826,y:32749,ptovrint:False,ptlb:SpecColor,ptin:_SpecColor,varname:node_8122,prsc:2,glob:False,c1:0.1,c2:0.1,c3:0.1,c4:1;n:type:ShaderForge.SFN_Slider,id:1449,x:32686,y:32967,ptovrint:False,ptlb:Shininess,ptin:_Shininess,varname:node_1449,prsc:2,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Tex2d,id:8161,x:32826,y:32327,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:node_8161,prsc:2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_SkyshopSpec,id:4121,x:33316,y:32812,varname:node_4121,prsc:2,sprot:True,spblend:True,splmocc:False|GLOSS-861-A;n:type:ShaderForge.SFN_Tex2d,id:861,x:32826,y:32508,ptovrint:False,ptlb:SpecMap,ptin:_SpecMap,varname:node_861,prsc:2,ntxv:0,isnm:False;proporder:8161-861-8122-1449;pass:END;sub:END;*/

Shader "DynaGI/Specular/LM_DynaGI_Basic_SF3wSpec_Code" {
    Properties {
...
////// Specular:
				...
				// Change
                //float3 indirectSpecular = (0 + marmoMipSpecular(viewReflectDirection, i.posWorld.rgb, _SpecMap_var.a).rgb);
				float3 indirectSpecular = (0 + (marmoMipSpecular(viewReflectDirection, i.posWorld.rgb, _SpecMap_var.a)).rgb);


				// Addition
				indirectSpecular *=	(dot(L1Direction, viewReflectDirection) * _L1Intensity)+(_RoomAmb*_L1Intensity);
...
/////// Diffuse:
					...
					//directDiffuse += lightmapAccumulation.rgb;
					directDiffuse += lightAccumulation.rgb;
                #endif
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 diffuse = directDiffuse * _MainTex_var.rgb;
                //diffuse *= 1-specularMonochrome;
/// Final Color:
                float3 finalColor = lightAccumulation.rgb ;//+ specular;
